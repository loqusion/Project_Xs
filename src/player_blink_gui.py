...
class PlayerBlinkGUI(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.auto_timeline_check = ttk.Checkbutton(
            self, text="Auto Timeline", variable=self.auto_timeline_check_var
        )
    ...
    def monitoring_work(self):
        ...
        if self.timelining:
            ...
            while queue and self.tracking:
                self.advances += 1
                if (
                    self.auto_timeline_check_var.get()
    ...
    def after_task(self):
        ...
        self.timeline_start = int(self.target_advances.get()) - int(
            self.timeline_buffer.get()
        )
        self.timeline_start_label["text"] = self.timeline_start
        self.press_a_label["text"] = int(self.target_advances.get()) - int(
            self.final_a_press_delay.get()
        )
